# Capturing your client contract

**This file is a method, not a contract.** It teaches you how to extract *your* client contract
from *your* aggregator and record it here, before the first line of supplier code is written.

Read [`README.md`](README.md) first. The rule it states applies to whatever you capture:
once recorded, the contract is **read-only input** to every supplier service.
